...
2. **Configure for POST Requests:** Ensure that your API endpoint is configured to handle POST requests. This is crucial as the Chatsistant will send token data via POST requests for verification.
...
1. **Token Submission:** Whenever a chat is rendered, Chatsistant automatically sends a verification request to the provided API endpoint. This request includes the user's token.
...
## Step 4: Inserting Your Token into Chatsistant Chatbot
...
<script src="https://app.chatsistant.com/widget-asset.min.js" defer></script>
```
...
```html
<iframe
  src="https://app.chatsistant.com/widget/162223v?token=<custom_token>"
  width="100%"
  height="500px"
  frameborder="0"
></iframe>
...
Congratulations! You have now successfully completed the setup of the User Identity Verification feature for your Chatsistant Chatbot.
