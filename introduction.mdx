...
2. **Use Chatsistant API for External Applications:** Integrate AI into your own app or workflow through Chatsistant's API.
...
<CardGroup cols={2}>
  ...
  >
    Interact directly with your Chatsistant account and bot settings via API
    endpoints.
  </Card>
  ...
  <Card
    title="Visit Chatsistant Website"
    icon="browser"
    href="https://chatsistant.com"
  >
  ...
  <Card
    ...
    href="https://app.chatsistant.com"
    color="#309C95"
  >
