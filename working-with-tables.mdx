...
Chatsistant allows you to upload training data in the form of **simple** CSV or Excel tables. 
...
If your data matches the format above, you can proceed to upload your table onto Chatsistant as a 
...
Chatsistant currently uses a version of JSON to handle tables. While not perfect, it does support a limited range 
...
The static table feature within Chatsistant is not optimized for them, and we instead recommend that you look into 
function-calling.
...
your Chatsistant chatbot as additional RAG context on-demand. However, this requires a bit of programming and server hosting 
