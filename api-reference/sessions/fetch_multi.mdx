...
api: "GET https://app.chatsistant.com/api/v1/chatbot/{uuid}/sessions"
...
```bash Curl
curl --location --request GET 'https://app.chatsistant.com/api/v1/chatbot/{uuid}/sessions' \
...
uuid = '<chatbot-uuid>'
url = f'https://app.chatsistant.com/api/v1/chatbot/{uuid}/sessions'
headers = {
...
const url = `https://app.chatsistant.com/api/v1/chatbot/${uuid}/sessions`;
const headers = {
  Authorization: "Bearer <token>",
};
