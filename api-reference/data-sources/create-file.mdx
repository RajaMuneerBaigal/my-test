---
title: "Upload a File"
api: "POST https://app.chatsistant.com/api/v1/chatbot/{uuid}/data-source/upload"
...
"' https://app.chatsistant.com/api/v1/chatbot/{uuid}/data-source/upload \
...
api_url = 'https://app.chatsistant.com/api/v1/chatbot/{uuid}/data-source/upload'
