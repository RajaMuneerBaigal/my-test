...
api: "POST https://app.chatsistant.com/api/v1/data-sources/url/re-scrape"
...
```bash Curl
curl --location --request POST 'https://app.chatsistant.com/api/v1/data-sources/url/re-scrape' \
...
url = 'https://app.chatsistant.com/api/v1/data-sources/url/re-scrape'
headers = {
...
const url = "https://app.chatsistant.com/api/v1/data-sources/url/re-scrape";
const headers = {
  "Content-Type": "application/json",
  Authorization: "Bearer <token>",
};
