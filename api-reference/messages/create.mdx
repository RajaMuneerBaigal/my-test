...
api: "POST https://app.chatsistant.com/api/v1/session/{uuid}/message/stream"
...
uuid = '<session-uuid>'
url = f"https://app.chatsistant.com/api/v1/session/{uuid}/message/stream"
headers = {
...
xhr.open(
  "POST",
  `https://app.chatsistant.com/api/v1/session/${uuid}/message/stream`,
  true
);
