...
1. An API key for accessing the Chatsistant API.
...
Here're example command sto create a chatbot using the Chatsistant API:
...
```bash Curl
curl --location --request POST 'https://app.chatsistant.com/api/v1/chatbot/create' \
...
```
https://app.chatsistant.com/api/v1/chatbot/{chatbot_uuid}/agents
```
...
```
https://app.chatsistant.com/api/v1/agent/{uuid}/update
```
...
```bash Curl
curl --location --request POST 'https://app.chatsistant.com/api/v1/agent/{uuid}/update' \
--header 'Content-Type: application/json' \
--header 'Authorization: Bearer <token>' \
--data-raw '{
...
uuid = '<agent-uuid>'
url = f'https://app.chatsistant.com/api/v1/agent/{uuid}/update'
headers = {
    'Content-Type': 'application/json',
    'Authorization': 'Bearer <token>'
}
...
const url = `https://app.chatsistant.com/api/v1/agent/${uuid}/update`;
const headers = {
  "Content-Type": "application/json",
  Authorization: "Bearer <token>",
};
