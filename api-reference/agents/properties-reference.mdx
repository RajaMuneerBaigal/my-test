...
<ParamField body="type" type="select">
  ...
  <p className="font-medium"><code>human-escalation</code> : Agent routes the user’s query to a human. Only one human-escalation agent is allowed in each chatbot. It requires Chatsistant UI to fully use this feature. </p>
