...
api: "GET https://app.chatsistant.com/api/v1/chatbot/{uuid}/agents"
...
```bash Curl
curl --location --request GET 'https://app.chatsistant.com/api/v1/chatbot/{uuid}/agents' \
...
uuid = '<chatbot-uuid>'
url = f'https://app.chatsistant.com/api/v1/chatbot/{uuid}/agents'
headers = {
...
const url = `https://app.chatsistant.com/api/v1/chatbot/${uuid}/agents`;
const headers = {
  Authorization: "Bearer <token>",
};
