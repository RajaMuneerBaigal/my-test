---
title: "Create Agent"
api: "POST https://app.chatsistant.com/api/v1/chatbot/<uuid>/agent/create"
...
url = 'https://app.chatsistant.com/api/v1/chatbot/{uuid}/agent/create'
headers = {
...
const url = "https://app.chatsistant.com/api/v1/chatbot/{uuid}/agent/create";
const headers = {
  "Content-Type": "application/json",
  Authorization: "Bearer <token>",
};
