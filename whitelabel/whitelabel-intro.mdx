...
- Your website URL (preferably separate from the address of your app. For example, the Chatsistant website is [https://gpt-trainer.com/](https://gpt-trainer.com/), while the Chatsistant app is hosted at [https://app.chatsistant.com](https://app.chatsistant.com)). Please include the `https://` part of your URL.
