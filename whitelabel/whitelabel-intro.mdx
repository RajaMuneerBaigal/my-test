...
The [whitelabel dashboard](https://partners.chatsistant.com) is the interface through which partners of Chatsistant can customize their own deployments of the app. Using the dashboard, partners are able to change the name, branding, and colors of the app. Partners are also able to manage their users, set their LLM API keys, and much more.

Before you can get started with the dashboard, you will need to reach out to Chatsistant staff with your email. We will provide you with a temporary password, which will enable you to log in to the dashboard. Once you have logged in, please change your password via the menu on the top right:
...
- Your website URL (preferably separate from the address of your app. For example, the Chatsistant website is [https://chatsistant.com/](https://chatsistant.com/), while the Chatsistant app is hosted at [https://app.chatsistant.com](https://app.chatsistant.com)). Please include the `https://` part of your URL.
...
It may take a few minutes for the record to propagate, so give it some time before adding the domain to your Chatsistant Partner dashboard. You must create the record first before using it in your dashboard.
...
_Once you know the email you want to use for this part, please contact us, Chatsistant, directly. We will work with you to verify your domain._
