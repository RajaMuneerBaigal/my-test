...
The files for our documentation are stored in our [public Github repository](https://github.com/ks-collab/chatsistant-docs). Feel free to refer to them when you create your own!
...
Once you have been approved, your Zapier integration should have a public link. For example, Chatsistant's link is: [https://zapier.com/apps/chatsistant/integrations](https://zapier.com/apps/chatsistant/integrations). You can paste this link into the Partners Dashboard once it's ready.