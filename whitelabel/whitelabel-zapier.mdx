...
Once you have been approved, your Zapier integration should have a public link. For example, Chatsistant's link is: [https://zapier.com/apps/gpt-trainer/integrations](https://zapier.com/apps/gpt-trainer/integrations). You can paste this link into the Partners Dashboard once it's ready.